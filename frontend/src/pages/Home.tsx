...
const Home: React.FC = () => {
  return (
  <div className="container mt-4 text-read">
      <div className="row">
        <div className="col-md-8 mx-auto">
          <div className="text-center mb-4 text-read">
            <h1 className="text-read">ASL Hand Sign Classifier</h1>
            <p className="lead text-read">
          ...
          <div className="mt-5">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title text-read" style={{ color: '#fff' }}>How it works</h5>
                <div className="row">
                  <div className="col-md-4 text-center">
                    ...
                    <h6 className="text-read" style={{ color: '#fff' }}>1. Upload</h6>
                    <p className="text-read" style={{ color: '#fff' }}>
                  ...
                  <div className="col-md-4 text-center">
                    ...
                    <h6 className="text-read" style={{ color: '#fff' }}>2. Analyze</h6>
                    <p className="text-read" style={{ color: '#fff' }}>
                  ...
                  <div className="col-md-4 text-center">
                    ...
                    <h6 className="text-read" style={{ color: '#fff' }}>3. Results</h6>
                    <p className="text-read" style={{ color: '#fff' }}>
